...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { io_spi_miso }]; #IO_L15P_T2_DQS_13 Sch=ck_io[32]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { io_spi_mosi }]; #IO_L21N_T3_DQS_13 Sch=ck_io[33]
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { io_spi_sck }]; #IO_L16P_T2_13 Sch=ck_io[34]
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { io_spi_ss }]; #IO_L22N_T3_13 Sch=ck_io[35]
...
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { io_uart_tx }]; #IO_L16N_T2_13 Sch=ck_io[40]
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { io_uart_rx }]; #IO_L14P_T2_SRCC_13 Sch=ck_io[41]
