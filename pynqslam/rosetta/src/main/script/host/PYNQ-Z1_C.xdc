...
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { io_btn3 }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
...
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { io_buffer_reset }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=ck_io[2]
#set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { ck_io[3] }]; #IO_L3N_T0_DQS_34 Sch=ck_io[3]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { io_io4_led }]; #IO_L10P_T1_34 Sch=ck_io[4]
